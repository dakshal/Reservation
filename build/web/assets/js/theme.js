var theme = function () {
    ...
    return {
        ...
        // Why we are
        initWhyWeAre: function () {
            $("#whyweare").owlCarousel({
                items: 1,
                itemsDesktop: false,
                itemsDesktopSmall: [991, 2],
                itemsTablet: [768, 1],
        ...
        initLastTweet: function () {
            $("#last-tweets").owlCarousel({singleItem: true, autoPlay: true, pagination: true });
        ...
        initLatestNews: function() {
            $('.latest-news .latest-news-article').mouseover(function(){
                var $parent = $(this).parent();
                $parent.find('.latest-news-article').removeClass('active');
                $(this).addClass('active');
            });
        },
        // Responsive search input
        initResponsiveSearch: function() {
            $('.header-search .form-control').on('focusin', function(){
                $(this).addClass('active');
            });
            $('.header-search .form-control').on('focusout', function(){
        ...
        initPropertySingleFlex: function() {
            $(window).load(function() {
                $('.property-single-slider').flexslider({
                    animation: "slide",
        ...
        // Sliding search
        initSlidingSearch: function() {
            $('#hs-icon').on('click', function() {
            ...
            $(document).on('click', function(e) {
                ...
                if (!$(target).is('#headersearch') && !$(target).parents().is('#headersearch') && !$(target).is('#hs-icon') && !$(target).parents().is('#hs-icon')) {
